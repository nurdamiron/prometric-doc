...
│   ├── owner-registration/            # Legacy документация владельца
│   ├── employee-registration/         # Legacy документация сотрудника
│   ├── login-authentication/          # Legacy документация входа
│   ├── password-management/           # Восстановление паролей
